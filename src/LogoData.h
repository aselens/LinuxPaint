...
// Логотип, вшитый прямо в исходный код.
//
// Раньше он лежал отдельным файлом и подхватывался то из ресурса, то из
// каталога установки, то из папки проекта. Каждый из этих путей зависел от
// того, как именно собрана и запущена программа, и в AppImage не работал ни
// один: ресурс не попадал в сборку, а системные пути указывали внутрь
// временной точки монтирования. Текст прямо в коде избавляет от всей этой
// цепочки — логотип едет вместе с бинарником, где бы тот ни оказался.

inline const char kLogoSvg[] = R"SVG(<svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="4096" height="4096">
