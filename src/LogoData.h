...
// Та же картинка лежит отдельным файлом logo.svg в корне проекта — он
// ставится в систему как значок приложения. Правки нужны в обоих местах,
// иначе значок в меню и значок в окне разойдутся.
//
// Из исходной картинки убран прямоугольник-подложка
// <rect width="100%" height="100%" fill="rgba(255,255,255,0)"/>.
// Он задумывался прозрачным фоном, но разборщик SVG в Qt не понимает запись
// цвета rgba() — только #rrggbb, rgb() и имена, — и нераспознанную заливку
// заменяет чёрной. А проценты в размерах без viewBox ему не на что опереть,
// так что прямоугольник выходил не во весь холст, а маленьким квадратом
// в начале координат: тем самым чёрным пятном в левом верхнем углу значка.
// Пустой фон и без него пуст, поэтому прямоугольник просто удалён,
// а viewBox добавлен — чтобы масштабирование было определено однозначно.

inline const char kLogoSvg[] = R"SVG(<svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" width="4096" height="4096" viewBox="0 0 4096 4096">
